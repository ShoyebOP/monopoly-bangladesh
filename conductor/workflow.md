...
9. **Push to Remote:**
   - **CRITICAL:** After every commit, immediately push changes to the remote repository.
...
10. **Attach Task Summary with Git Notes:**
   ...
   - **Step 10.3: Attach Note:** Use the `git notes` command to attach the summary to the commit.
     ...
     ```
   - **Step 10.4: Push Notes to Remote:** Push the git notes to the remote repository.
     ```bash
...
7.  **Push to Remote:**
    -   **CRITICAL:** Immediately push the checkpoint commit to the remote repository.
    -   Execute: `git push origin <branch-name>`
    -   Verify push succeeded before proceeding.
...
8.  **Attach Auditable Verification Report using Git Notes:**
    ...
    -   **Step 8.3: Push Notes to Remote:** Push the git notes to the remote repository.
        ```bash
        git push origin refs/notes/*:refs/notes/*
        ```
